...
$heroImage = $voxHomeValue('hero_image', DOMAIN_THEME_IMG . 'hero-vox-hearing-v14.png');
$serviceImages = [
    1 => $voxHomeValue('service_1_image', 'https://images.unsplash.com/photo-1581056771107-24ca5f033842?auto=format&fit=crop&w=700&q=80'),
    2 => $voxHomeValue('service_2_image', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=700&q=80'),
    3 => $voxHomeValue('service_3_image', 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?auto=format&fit=crop&w=700&q=80'),
    4 => $voxHomeValue('service_4_image', 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=700&q=80'),
];
$aboutImage = $voxHomeValue('about_image', 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=1000&q=85');
?>
<section class="hero" style="--hero-image:url(&quot;<?php echo $heroImage; ?>&quot;)" data-vox-edit-image="hero_image" data-vox-image-url="<?php echo $heroImage; ?>">
